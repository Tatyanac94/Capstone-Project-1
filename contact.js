 // I created elements and variables needed for managing events, interacting with the calendar, handling alerts, and closing modal dialogs in the JavaScript functionality related to the calendar component.
...
//I set up a custom button on the calendar that, when clicked, displays a modal dialog for adding an event. It handles updating the modal content and button behavior, as well as closing the modal when needed.
  const calendar = new FullCalendar.Calendar(calendarEl, {
    customButtons: {
      customButton: {
        text: 'Consult with Tatyana Cuttino',
        click: function () {
          myModal.show();
